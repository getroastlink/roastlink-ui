...
| --- | --- | --- |
| `fan` | level `0`-`10` | TWO and CORE families with fan hardware |
| `fan_pct` | percent `0`-`100` | TWO and CORE families with fan hardware |
| `fan_nudge` | signed percent change | TWO and CORE families with fan hardware |
